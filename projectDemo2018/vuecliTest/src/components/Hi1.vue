<template>
  <div class="hello">
    ...
    <div class="tips">
      ...
      <p>
        <strong>redirect</strong>：仔细观察URL，redirect是直接改变了url的值，把url变成了真实的path路径。
      </p>
      <p>
        <strong>alias</strong>：URL路径没有别改变，这种情况
        <span style="font-weight:800;color:blue;">更友好</span>，让用户知道自己访问的路径，只是改变了&lt;router-view&gt;中的内容。
      </p>
    ...
    <div>
      我是user组件, 动态部分是
      <span style="color:green;font-weight:800;padding-left:5px;">{{dynamicSegmentC}}</span>
    </div>
    <p>注：点击路径上带参数的才可以哦！</p>
...
export default {
  ...
  computed: {
    dynamicSegmentC() {
      return (this.dynamicSegment = this.$route.params.id
